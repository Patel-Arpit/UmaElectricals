...
$meta_title = 'UMA ELECTRICALS & SERVICES';
$meta_desc = 'UMA ELECTRICALS & SERVICES';
$meta_keyword = 'UMA ELECTRICALS & SERVICES';
                    ...
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5">
                                <div class="logo">
                                    <a href="index.php"><img src="images/logo/uma.png" alt="logo images"></a>
                                </div>
                            </div>
                            <div class="col-md-7 col-lg-7 col-sm-5 col-xs-3">
                                <nav class="main__menu__nav hidden-xs hidden-sm">
                                    <ul class="main__menu">
                                        ...
                                        <li class="drop"><a href="#">company</a>
                            ...
                            <div class="col-md-3 col-lg-3 col-sm-4 col-xs-4">
                                <div class="header__right">
                                    ...
                                    <div class="htc__shopping__cart">
                                        ...
                                        <?php if (isset($_SESSION['USER_LOGIN'])) { ?>
                                            <a href="wishlist.php"><i class="icon-heart icons" style="margin: 0px 13px;"></i></a>
